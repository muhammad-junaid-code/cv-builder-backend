...
"""
    ...
    if company_context or company_name:
        _company_proj_block = (
            ...
            "    bullet 2: technical challenge solved + UNIQUE concrete believable metric (20-30 words)\n"
            "    bullet 3: business outcome with UNIQUE believable number (20-30 words)\n"
        ...
        _company_proj_block = (
            ...
            "DOMAIN ALIGNMENT REQUIREMENT:\n"
            "  All 4 projects MUST belong to the same industry/domain implied by the JD.\n"
            "  If the JD is for a logistics company: all 4 projects should be logistics/supply-chain aligned (tracking, dispatch, warehouse, routing).\n"
            ...
            "    bullet 2: technical challenge faced + how it was solved + UNIQUE concrete metric (20-30 words)\n"
            "    bullet 3: business outcome + UNIQUE believable number (20-30 words)\n"
            "- No two projects may share the same bullet structure or metric format.\n"
            "- All project names must feel like they belong to the same company's product suite.\n"
        )
